        ...
        {hasAction && (
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              fontSize: 11,
              color: 'var(--color-warning, oklch(75% 0.18 55))',
              opacity: 0.8,
              lineHeight: 1.4,
            }}
          >
        ...
        <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start', padding: '16px 0' }}>
          ...
          <div>
            ...
            >
              ...
              administrator is not enough — the app must be launched with UAC elevation. Click below
              to restart MiControl as administrator.
            </div>
            {error && (
  ...
  return (
    <div className="card" style={{ marginTop: 14 }}>
        ...
        <>
          ...
          <div className="card" style={{ marginBottom: 14 }}>
            ...
            <div style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 10 }}>
              Direct ECRAM writes via IoTDriver. Changes take effect immediately; some may require a
              fan/profile cycle to apply.
            </div>
      ...
      <details>
        ...
        <div className="card" style={{ marginTop: 8, marginBottom: 0 }}>
          <div style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 10 }}>
            Direct write to any physical address via IOCTL 0x22E004. Use only with verified-safe
            offsets.
          </div>
