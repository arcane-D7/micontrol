  ...
  const PlusBtn = ({ resource }: { resource: "cpu" | "gpu" | "ram" }) => (
    <button
      ...
      style={{
        ...
        color: "var(--color-text-dim)", fontSize: 13, lineHeight: 1,
        padding: "0 2px", marginLeft: 4, opacity: 0.7,
      }}
    >
      ⊕
    </button>
  ...
  return (
    <div className="card">
      ...
      <div style={{ marginBottom: 12 }}>
        ...
        <div className="progress-bar">
          <div className={`progress-fill ${gpuUsageColor}`} style={{ width: `${info.gpu_usage}%` }} />
        </div>
      </div>
